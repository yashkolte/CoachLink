...
public class ApiResponse<T> {
     ...
     * Useful for displaying user-friendly messages in the frontend
     */
    ...
    /**
     * Factory method for creating successful responses with custom message and data
     * 
     * @param <T> The type of data being returned
     * @param message Custom success message
     * @param data The response data
     * @return ApiResponse with success=true, custom message, and the provided data
     */
