 ...
 * application and the backend API. It's specifically configured to:
 * - Allow requests from the Next.js frontend application
 * - Support all necessary HTTP methods for RESTful operations
 ...
 * by using configurable allowed origins.
 * 
 * @author Yash Kolte
 * @version 1.0
 * @since 2024
...
public class CorsConfig implements WebMvcConfigurer {
     ...
     * Typically includes frontend application URLs (e.g., http://localhost:3000 for dev)
     */
     ...
     * It allows all standard REST methods and enables credential sharing
     ...
     * 
     * This bean provides a fallback CORS configuration for all endpoints
     * that aren't explicitly mapped above. It's more permissive and useful
     * for development environments or when specific endpoint mapping isn't needed.
     * 
